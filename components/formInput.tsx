...
const FormInput = (props: { label: string, type: string, state: string, setState: Function }) => {
  ...
  const textArea = "bg-transparent border-[2mm] border-slate-800 rounded-2xl p-2 focus:outline-none focus:border-indigo-300 transition-all min-w-[250px] min-h-[250px]"
